...
async def analyze_intelligent_endpoint(documents: List[UploadFile] = File(...)):
    if not documents: raise HTTPException(status_code=400, detail="No files were uploaded.")
